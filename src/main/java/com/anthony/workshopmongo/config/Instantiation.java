...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("02/04/2025"), "O vasco empatou ontem","O vasco empatou ontem por culpa de Carille", maria);
		Post post2 = new Post(null, sdf.parse("03/04/2025"), "Estou conseguindo estudar", "Estou conseguindo estudar Spring boot", maria);
